...
```{r,include=FALSE}
new_file <- "single_2024_wbr/vol_native_20241122_wbr_IDP_T1_FIRST_right_accumbens_volume.regenie.gz"
old_file <- "0024.txt.gz"
```
...
if (any(gws_ukbrap)) print(ukbrap_plot)
if (any(gws_big40)) print(big40_plot)
```
