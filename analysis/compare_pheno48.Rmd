...
old_file <- "ukb_phase1to3_heart_may_2022_pheno48.fastGWA"
```

## UKB-WGS

```{r, include=FALSE}
new_file <- "single_20250401_eur/hfpef_mri_single_20250401_eur_Ell_global.regenie.gz"
```
...
```{r, include=FALSE}
new_file <- "single_20250201_wbr/hfpef_mri_single_20250201_wbr_Ell_global.regenie.gz"
```
