...
old_file <- "ukb_phase1to3_heart_may_2022_pheno82.fastGWA"
```

## UKB-WGS

```{r, include=FALSE}
new_file <- "single_20250401_eur/hfpef_mri_single_20250401_eur_Err_global.regenie.gz"
```
...
```{r, include=FALSE}
new_file <- "single_20250201_wbr/hfpef_mri_single_20250201_wbr_Err_global.regenie.gz"
```
