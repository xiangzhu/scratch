...
old_file <- "GCST90019013.h.tsv.gz"
```

## UKB-WGS

```{r, include=FALSE}
new_file <- "single_20250401_eur/hfpef_mri_single_20250401_eur_PDSR_longit.regenie.gz"
```
...
```{r, include=FALSE}
new_file <- "single_20250201_wbr/hfpef_mri_single_20250201_wbr_PDSR_longit.regenie.gz"
```
