...
old_file <- "ukb_phase1to3_heart_may_2022_pheno27.fastGWA"
```

## UKB-WGS

```{r, include=FALSE}
new_file <- "single_20250401_eur/hfpef_mri_single_20250401_eur_WT_global.regenie.gz"
```
...
```{r, include=FALSE}
new_file <- "single_20250201_wbr/hfpef_mri_single_20250201_wbr_WT_global.regenie.gz"
```
