...
new_file <- "single_20241220_eur_sn_l_swi_50th.regenie.gz"
```
...
old_file <- "dcf_rickidps_single_20241220_wbr_sn_l_swi_idps_MNI2006a_50th.regenie.gz"
```
...
old_file <- "swi_median_20241220_wbr_sn_l_swi_idps_MNI2006a_50th.regenie.gz"
```
