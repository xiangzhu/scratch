---
title: "Compare GWAS results on the same trait from two versions of input data"
...
```{r, include=FALSE}
old_file <- "/Users/xiangzhu/Downloads/tmp/step1_app_step2_app/hfpef_aba_single_20250201_wbr_seg34_step2_aba_hfpef.regenie.gz"
```
