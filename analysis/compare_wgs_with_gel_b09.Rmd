...
new_file <- "single_20241220_eur_sn_r_qsm_50th.regenie.gz"
```
...
old_file <- "dcf_rickidps_single_20241220_wbr_sn_r_qsm_idps_MNI2006a_50th.regenie.gz"
```
...
old_file <- "qsm_median_20241220_wbr_sn_r_qsm_idps_MNI2006a_50th.regenie.gz"
```
